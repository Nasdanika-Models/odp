...
public class OdpToEcoreResourceContentsHandler implements ResourceContentsHandler<EPackage[]> {
	...
	public OdpToEcoreResourceContentsHandler(Resource resource, ResourceContentsHandler<Document> docuentHandler) {
