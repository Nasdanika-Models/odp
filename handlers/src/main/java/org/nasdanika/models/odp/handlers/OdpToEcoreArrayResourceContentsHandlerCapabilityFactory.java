package org.nasdanika.models.odp.handlers;
...
public class OdpToEcoreArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected ResourceContentsHandler<EObject[]> createHandler(Resource resource, ResourceContentsHandler<Document> dh) {
		return new OdpToEcoreResourceContentsHandler(resource, dh).adaptToEObjectArrayContentsHandler();
	}
