package org.nasdanika.models.odp.capability;
 ...
 */
public class OdpArrayResourceContentsHandlerCapabilityFactory extends ServiceCapabilityFactory<org.nasdanika.capability.emf.ResourceContentsHandler.Requirement, ResourceContentsHandler<EObject[]>> {
	...
	protected CompletionStage<Iterable<CapabilityProvider<ResourceContentsHandler<EObject[]>>>> createService(
		...
		return wrap(new OdpResourceContentsHandler().adaptToEObjectArrayContentsHandler());
	}
