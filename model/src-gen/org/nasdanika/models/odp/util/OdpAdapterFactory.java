 ...
 * @generated
 */
public class OdpAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected OdpSwitch<Adapter> modelSwitch =
		new OdpSwitch<Adapter>() {
			@Override
			public Adapter caseOdpPresentation(OdpPresentation object) {
				return createOdpPresentationAdapter();
			}
			@Override
			public Adapter caseOdpSlide(OdpSlide object) {
				return createOdpSlideAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseOdpShape(OdpShape object) {
				return createOdpShapeAdapter();
			}
			@Override
			public Adapter caseOpaqueElement(OpaqueElement object) {
				return createOpaqueElementAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.odp.OdpPresentation <em>Presentation</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOdpPresentationAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.odp.OdpSlide <em>Slide</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOdpSlideAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.odp.Style <em>Style</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.odp.OdpShape <em>Shape</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOdpShapeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.odp.OpaqueElement <em>Opaque Element</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.nasdanika.models.presentation.Shape <em>Shape</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.nasdanika.models.presentation.Shape
	 * @generated
	 */
